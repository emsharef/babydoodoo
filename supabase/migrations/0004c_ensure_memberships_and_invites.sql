-- 0004c_ensure_memberships_and_invites.sql
-- Purpose: Idempotently ensure memberships + invites exist with correct RLS policies.
-- Safe to run regardless of prior 0004/0004b state.
...
-- BABIES policies (recreate to be membership-aware)
...
-- EVENTS policies (membership-aware)
...
-- INVITES policies (no NEW.* references)
